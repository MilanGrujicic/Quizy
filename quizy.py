...
class Quizy:
    def __init__(self):
        ...
        options = Button(text='Options', width=10, bg="#fff500", highlightbackground = "black", border="2", command=utils.open_options)
        options.grid(row=2, column=0, pady=5)
        exit = Button(text='Exit', width=10, bg="#fff500", highlightbackground = "black", border="2", command=self.window.destroy)
        exit.grid(row=3, column=0, pady=5)
